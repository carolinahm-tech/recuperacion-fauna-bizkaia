...
\includegraphics[width=\textwidth,height=6cm,keepaspectratio]{images/gaviota.jpg}
...
\textcolor{ForestGreen}{\textbf{GUÍA ILUSTRADA}}}

\vspace{0.35cm}

{\fontsize{17}{21}\selectfont
\textcolor{Brown}{
Las tres especies con mayor número de ingresos en el Centro de Recuperación de Fauna Silvestre de Bizkaia}}

\vspace{0.45cm}

{\large
Descubriendo la fauna a través del análisis de datos}

\vspace{0.55cm}

{\color{SoftGreen}\rule{0.60\textwidth}{0.6pt}}
...
\centering
\includegraphics[width=\linewidth,height=4.3cm,keepaspectratio]{images/jabali.jpg}
...
\begin{minipage}{0.46\textwidth}
\centering
\includegraphics[width=\linewidth,height=4.3cm,keepaspectratio]{images/tortuga.jpg}
...
{\large
Datos Públicos del Centro de Recuperación de Fauna Silvestre de Bizkaia}
...
\textbf{Power BI · SQL · Python}

\vfill

{\color{SoftGreen}\rule{0.60\textwidth}{0.6pt}}

{\large Carolina Horcajada Molinero}
...
\faChartBar\ Finalmente, la información fue analizada mediante SQL, Python y Power BI para identificar patrones, tendencias y especies con mayor frecuencia de ingreso.
...
{\fontsize{24}{28}\selectfont
\textcolor{ForestGreen}{\textbf{TORTUGA DE FLORIDA}}
}

\vspace{0.1cm}

{\large\itshape Trachemys scripta}
...
El análisis de datos no solo permite descubrir patrones y tendencias.

También ayuda a comprender mejor la biodiversidad y a transformar grandes volúmenes de información en conocimiento útil para la conservación de la fauna.
...
\faGithub\ Análisis y guía elaborados por Carolina Horcajada Molinero

\vspace{0.2cm}

\small

Basada en datos abiertos de la Diputación Foral de Bizkaia (2022--2025).
